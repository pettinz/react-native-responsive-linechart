...
var HorizontalAxis = function (props) {
    var _a = deepmerge_1.default(defaultProps, props), _b = _a.theme, axis = _b.axis, ticks = _b.ticks, grid = _b.grid, labels = _b.labels, tickValues = _a.tickValues, tickCount = _a.tickCount, labelValues = _a.labelValues, includeOriginTick = _a.includeOriginTick;
    ...
    return (React.createElement(React.Fragment, null,
        ...
        finalTickValues.map(function (value, index) {
            var _a;
            return (React.createElement(React.Fragment, { key: value },
                ...
                labels.visible && (React.createElement(react_native_svg_1.G, { translateX: labels.label.dx + utils_1.scalePointToDimensions({ x: value, y: 0 }, viewportDomain, dimensions).x, translateY: dimensions.height - labels.label.dy },
                    React.createElement(react_native_svg_1.Text, { fontSize: labels.label.fontSize, fontWeight: labels.label.fontWeight, fontFamily: labels.label.fontFamily, fill: labels.label.color, opacity: labels.label.opacity, textAnchor: labels.label.textAnchor, rotation: labels.label.rotation }, (_a = (labelValues && labelValues[index])) !== null && _a !== void 0 ? _a : labels.formatter(value))))));
        })));
};
